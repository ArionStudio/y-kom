...
--
-- Host: 127.0.0.1
-- Czas generowania: 30 Lis 2020, 15:55
...
(14, 'Procesor', '1.00', 5, 'sdasdasdasd', 1, 13),
(15, 'Procesor', '1.00', 5, 'sdasdasdasd', 1, 16);
...
--
ALTER TABLE `employeelogintime`
  MODIFY `idLogged` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`idFoto`) REFERENCES `productgallery` (`idFoto`);
